...
- Design a scalable system that can later integrate GPS and ML-based prediction
- Ensure mobile-first, user-friendly access to transit information
...
- **ML (Future Enhancement)**: Python (Linear Regression)
...
- Deployment-friendly environment setup
